...
const Reclamations = () => {
  ...
  const [claimsData, setClaimsData] = useState([
    ...
    {
      id: 3,
      student: "Sagittu Laurent",
      order: "#COR-2024-H5",
      subject: "Commande perdue",
      description: "Ma commande n'est jamais arrivée alors que le statut indique 'livré'. Où est ma commande ?",
      priority: "high",
      status: "in-progress",
      date: "2024-01-13",
      responses: [
        { sender: "Sagittu Laurent", message: "Ma commande n'est pas arrivée depuis 2 heures.", time: "2024-01-13 18:20" },
        { sender: "Support", message: "Nous contactons le livreur pour localiser votre commande.", time: "2024-01-13 19:05" }
      ]
    },
    {
      id: 4,
      ...
      description: "La livraison a pris plus d'une heure alors que c'était censé être en 30 minutes maximum.",
      priority: "medium",
      status: "pending",
      date: "2024-01-12",
      responses: [
        { sender: "Marie Dubois", message: "Je suis très déçue par le retard de livraison.", time: "2024-01-12 20:15" }
      ]
    },
    {
      id: 5,
      ...
      description: "Il manque la boisson dans ma commande. Tout le reste est correct.",
      priority: "low",
      status: "resolved",
      date: "2024-01-11",
      responses: [
        { sender: "Paul Martin", message: "Il manque ma boisson dans la commande.", time: "2024-01-11 12:45" },
        { sender: "Support", message: "Nous vous remboursons le prix de la boisson.", time: "2024-01-11 13:20" }
      ]
    }
  ]);
  ...
  return (
    <div className="App">
      <Header theme={theme} toggleTheme={toggleTheme} activePage="reclamations" notificationCount={notificationCount} />
