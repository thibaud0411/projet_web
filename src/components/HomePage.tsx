...
const testimonials = [
  {
    ...
    avatar: 'https://assets.spaceappschallenge.org/media/images/IMG-20250922-WA0007_vtAKdtK.2e16d0ba.fill-134x134.jpg'
  },
  {
    name: 'Benie Cecilda',
    faculty: 'Institut Ucac-Icam',
    ...
    <div className="min-h-screen bg-[#FAF3E0]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <button className="text-[#000000] hover:text-[#cfbd97] transition-colors pb-1">Contact</button>
            </nav>
      ...
      >
        <div className="absolute inset-0 opacity-20">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1665332195309-9d75071138f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwZm9vZCUyMGpvbGxvZnxlbnwxfHx8fDE3NTk3NDQ1MjJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
